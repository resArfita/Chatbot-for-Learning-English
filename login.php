...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	//check user table
	$user_query="SELECT * FROM user WHERE username='$username' AND password='$encrypted_password'";
	$user_result=$conn->query($user_query);

	//check admin table
	$admin_query="SELECT * FROM admin WHERE username='$username' AND password='$encrypted_password'";
	...
	<body>
		<div class="login">
			...
			<form method="POST">
				...
				<input type="submit" class="btn btn-primary btn-block btn-large" name="submit" value="Login">
			</form>
			<p style="color: #ffffffe5; text-align: center; margin-top: 2%;">Belum punya akun ? <a href="register.php">Register</a></p>
		</div>
